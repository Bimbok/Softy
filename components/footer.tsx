...
export const Footer = () => {
  return (
    <div className="flex gap-4 items-center fixed bottom-6 right-6 z-50">
      ...
      <Link target="_blank" className={buttonVariants({ size: "icon", variant: "ghost" })} href={socialLinks.x} title="X (Twitter)">
        <XLogoIcon className="size-5 text-white/50 hover:text-white transition-colors" />
      </Link>
